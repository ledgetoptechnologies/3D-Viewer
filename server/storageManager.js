...
class StorageManager {
  ...
  requireDerivativeSpace(rootKey,{sourceBytes,expectedFiles=10000,reservedBytes=0,otherReservedBytes=0,reservedDatasetBytes=[]}={}){
    ...
    if(!Number.isSafeInteger(bytes)||bytes<0||bytes>16*gib||!Number.isSafeInteger(reserved)||reserved<0||!Number.isSafeInteger(other)||other<0)throw Object.assign(new Error('derivative source size is outside the supported bound'),{code:'insufficient_storage'});
